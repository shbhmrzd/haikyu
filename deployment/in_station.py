...
class InStation:
    ...
    def __init__(self,
        ...
        InStation.total_count += 1

        if self.vehicle_type == VehicleTypes.ALS:
            InStation.vehicle_counts[VehicleTypes.ALS] +=1
        elif self.vehicle_type == VehicleTypes.HMV_4X4:
            InStation.vehicle_counts[VehicleTypes.HMV_4X4] +=1
        elif self.vehicle_type == VehicleTypes.ARMY_BUS:
            InStation.vehicle_counts[VehicleTypes.ARMY_BUS] +=1
        elif self.vehicle_type == VehicleTypes.WATER_BOWSER_5KL:
            InStation.vehicle_counts[VehicleTypes.WATER_BOWSER_5KL] +=1
        elif self.vehicle_type == VehicleTypes.WATER_BOWSER_2KL:
            InStation.vehicle_counts[VehicleTypes.WATER_BOWSER_2KL] +=1